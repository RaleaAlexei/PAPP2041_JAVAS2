    ...
    private void refreshViewLanguages() {
        ...
        buttonStartNewGame.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                onStartNewGameButtonClicked(view);
            }
        });

        buttonAddNewBoard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                onAddNewBoardButtonClicked(view);
            }
        });

        buttonShowInstructions.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                onShowInstructionsButtonClicked(view);
            }
        });
    }
